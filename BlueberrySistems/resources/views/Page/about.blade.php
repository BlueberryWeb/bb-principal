...
<body>
                    ...
                    <div class="content pt-0">
                        ...
                        <ul class="feat">
                            ...
                            <li class="wow fadeInUp" data-wow-delay=".4s">
                                <h6 class="semiBold fz-20"><span>2</span> Reaching your goals</h6>
                                <p class="fz-16">Developing client’s vision through technology with the expertise of our web 
                                    developers, in Blueberry we cover all your needs, from landing pages to a 
                                    whole digital platform development, warranting you the quality and security 
                                    management standards.
                                </p>
                            </li>
                            <li class="wow fadeInUp" data-wow-delay=".6s">
                                <h6 class="bold fz-20">15 + years of experience </h6>
                                <h6 class="bold fz-20"> 100 + happy clients</h6>
    ...
    <section class="clients section-padding">
        <div class="container">
            <img src="https://res.cloudinary.com/dej55trpk/image/upload/v1675785613/nosotros/brads-we-helped_arhhca.png" alt="Marcas que ayudamos a crecer"/>
        </div>
    </section>
                    ...
                    <div class="content wow fadeInUp md-mb30" data-wow-delay=".5s">
                        <div class="skills-box mt-40">
                            <div class="skill-item">
                                <h6 class="custom-font fz-70 semiBold">Evidence-based science</h6>
                                <div class="skill-progress">
                                    <div class="progres" data-value="100%"></div>
                                </div>
                            </div>
                            <div class="skill-item">
                                <h6 class="custom-font fz-70 semiBold">Cutting-edge techology</h6>
                                <div class="skill-progress">
                                    <div class="progres" data-value="100%"></div>
                                </div>
                            </div>
                            ...
                            <div class="skill-item">
                                <h6 class="custom-font fz-70 semiBold">Life changing experience</h6>
                                <div class="skill-progress">
                                    <div class="progres" data-value="100%"></div>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <div class="col-lg col-md-6 item bg-img wow fadeInUp" data-background="https://res.cloudinary.com/dej55trpk/image/upload/v1675785610/nosotros/bb_01_yqqnng.jpg" data-wow-delay=".2s">
                    ...
                    <p>
                        We build it, you own it. It’s that simple. Once we finish development, 
                        we pass over the complete source code so that your project is yours.
                    </p>
                </div>
                ...
                <div class="col-lg col-md-6 item bg-img wow fadeInUp" data-background="https://res.cloudinary.com/dej55trpk/image/upload/v1675785610/nosotros/bb_03_d1gs9p.jpg" data-wow-delay=".6s">
                    ...
                    <p>Our company is built on long-term partnerships. We do this through our commitment to 
                        absolute transparency about everything.
                    </p>
                </div>
                ...
                <div class="col-lg col-md-6 item bg-img wow fadeInUp" data-background="https://res.cloudinary.com/dej55trpk/image/upload/v1675785611/nosotros/bb_05_gfqwce.jpg" data-wow-delay="1s">
                    ...
                    <p>We look forward to delivering high-quality results that meet, not just the requirements of our clients, 
                        but the platform on which the website is built.
                    </p>
                </div>
