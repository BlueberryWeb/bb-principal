                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg col-md-6">
                            <div class="item mb-30 tam-cards-ch wow fadeIn" data-wow-delay=".3s">
                                ...
                                <p class="bold fz-16"> Somos una agencia <b class="color-font">creativa de software.</b>
                                </p>
                            </div>
                        </div>
                        <div class="col-lg col-md-6">
                        ...
                        <div class="col-lg col-md-6">
                            <div class="item mb-30 tam-cards-ch wow fadeIn" data-wow-delay=".8s">
                                ...
                                <p class="mb-25 bold fz-16"> Construcción del proyecto con <b class="color-font">alta tecnología.</b> 
                                    <br>
