                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 items md-mb30">
                        <div class="item wow fadeIn" data-wow-delay=".3s">
                            ...
                            <p>We work in compliant with ISO 9001 quality management and information security management standards. 
                    ...
                    <div class="col-lg-3 col-md-6 items active md-mb30">
                        <div class="item wow fadeIn" data-wow-delay=".6s">
                            ...
                            <p> We asses projects and decide the best ideas to bring your desired website to life.
                            </p>
                        </div>
                    </div>
